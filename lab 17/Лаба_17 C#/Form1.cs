...
namespace Лаба_17
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    AddOperation(arrayListResults, linkedListResults, count = 5);
                    break;
                case 1:
                    GetOperation(arrayListResults, linkedListResults, count=4);
                    break;
                case 2:
                    SetOperation(arrayListResults, linkedListResults, count=4);
                    break;
                case 3:
                    InsertOperation(arrayListResults, linkedListResults, count=5);
                    break;
                case 4:
                    RemoveOperation(arrayListResults, linkedListResults, count=5);
                    break;
            }
            GraphResults(arrayListResults, linkedListResults, count);
        }

        private void AddOperation(double[] arrayListResults, double[] linkedListResults, int count = 5)
        {
            int k = 0;
        ...
        private void GetOperation(double[] arrayListResults, double[] linkedListResults, int count = 4)
        {
            int k = 0;
            var arrayList = new MyArrayList<int>();
            var linkedList = new MyLinkedList<int>();
        ...
        private void SetOperation(double[] arrayListResults, double[] linkedListResults, int count = 4)
        {
            int k = 0;
            var arrayList = new MyArrayList<int>();
            var linkedList = new MyLinkedList<int>();
        ...
        private void InsertOperation(double[] arrayListResults, double[] linkedListResults, int count = 5)
        {
            int k = 0;
            var arrayList = new MyArrayList<int>();
            var linkedList = new MyLinkedList<int>();
        ...
        private void RemoveOperation(double[] arrayListResults, double[] linkedListResults, int count = 5)
        {
            int k = 0;
            var arrayList = new MyArrayList<int>();
            var linkedList = new MyLinkedList<int>();
        ...
        private void GraphResults(double[] arrayListResults, double[] linkedListResults, int count)
        {
